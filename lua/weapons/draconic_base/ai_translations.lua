function SWEP:SetupWeaponHoldTypeForAI(t)
	...
	if t == "ar2" then
		...
		self.ActivityTranslateAI [ACT_RUN_RELAXED]                      = ACT_RUN_RIFLE_RELXED
	...
	elseif t == "smg" then
		...
		self.ActivityTranslateAI [ACT_RUN_CROUCH_AIM]                   = ACT_RUN_CROUCH_AIM_RIFLE
		self.ActivityTranslateAI [ACT_COVER_LOW]						= ACT_COVER_SMG1_LOW
		self.ActivityTranslateAI [ACT_RANGE_AIM_LOW]                    = ACT_RANGE_AIM_AR2
		...
		self.ActivityTranslateAI [ACT_GESTURE_RANGE_ATTACK1]            = ACT_GESTURE_RANGE_ATTACK_PISTOL
		self.ActivityTranslateAI [ACT_RANGE_ATTACK1]                    = ACT_RANGE_ATTACK_PISTOL
		self.ActivityTranslateAI [ACT_MP_RUN] 							= ACT_RUN
		self.ActivityTranslateAI [ACT_RELOAD]                           = ACT_RELOAD_PISTOL
		self.ActivityTranslateAI [ACT_IDLE]                             = ACT_IDLE_PISTOL
		self.ActivityTranslateAI [ACT_IDLE_ANGRY]                       = ACT_IDLE_ANGRY_PISTOL
		self.ActivityTranslateAI [ACT_WALK]                             = ACT_WALK_PISTOL
		self.ActivityTranslateAI [ACT_MP_CROUCHWALK] 					= ACT_WALK_AIM_PISTOL
		...
		self.ActivityTranslateAI [ACT_WALK_AIM_RELAXED]                 = ACT_WALK_PISTOL
		...
		self.ActivityTranslateAI [ACT_GESTURE_RELOAD]                   = ACT_RELOAD_PISTOL
		...
		self.ActivityTranslateAI [ACT_GESTURE_RANGE_ATTACK1]            = ACT_GESTURE_RANGE_ATTACK_PISTOL
		self.ActivityTranslateAI [ACT_RANGE_ATTACK1]                    = ACT_RANGE_ATTACK_PISTOL
		self.ActivityTranslateAI [ACT_MP_RUN] 							= ACT_RUN_PISTOL
		self.ActivityTranslateAI [ACT_RELOAD]                           = ACT_RELOAD_PISTOL
		self.ActivityTranslateAI [ACT_IDLE]                             = ACT_IDLE
		self.ActivityTranslateAI [ACT_IDLE_ANGRY]                       = ACT_IDLE_ANGRY_PISTOL
		self.ActivityTranslateAI [ACT_WALK]                             = ACT_WALK
		self.ActivityTranslateAI [ACT_MP_CROUCHWALK] 					= ACT_WALK_CROUCH
		self.ActivityTranslateAI [ACT_IDLE_RELAXED]                     = ACT_RANGE_ATTACK_PISTOL
		self.ActivityTranslateAI [ACT_IDLE_STIMULATED]                  = ACT_RANGE_ATTACK_PISTOL
		self.ActivityTranslateAI [ACT_IDLE_AGITATED]                    = ACT_RANGE_ATTACK_PISTOL
		...
		self.ActivityTranslateAI [ACT_RUN_CROUCH_AIM]                   = ACT_RUN_CROUCH
		self.ActivityTranslateAI [ACT_COVER_LOW]						= ACT_COVER_PISTOL_LOW
